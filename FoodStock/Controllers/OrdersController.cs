...
namespace FoodStock.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            ViewBag.FoodID = new SelectList(db.Menus, "ID", "FoodName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,OrderOn,OrderedBy,FoodID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,OrderOn,OrderedBy,FoodID")] Order order)
        {
            if (ModelState.IsValid)
            {
